...
- [Notion 的底层逻辑](#1-Notion_的底层逻辑)
- [BpCoffee Team Home 运作介绍](#2-BpCoffee_Team_Home_运作介绍)
- [Notion 实例](#3-Notion_实例)
- [Notion 进阶理解资料](#4-Notion_进阶理解资料)
- [Tips](#5-Tips)
...
如何添加一个 Block 呢？在 Page 中新建一行，输入`/`会弹出 Block 类型列表供搜索和选择。
...
6. 及时在对应 Page 中更新信息，可以把相关链接，思考过程补充在最下方（在任务信息中点击 Edit Page Content，之后就可以随意书写了）
7. **善用 Add a comment**
